...
def game(num_doors, num_gift):
    ...
    player2 = int(input("Игрок 2 - Выбери дверь: "))
    if player1 == 1 and player2 == 2:
        last_door = (door[2])
        if last_door == 'пусто':
            print('За дверью 1 или 2 находится приз')
            print("Игрок 1 изменил свой выбор")
            print("Шанс победы игрока №1: 0.6667")
            print("Шанс победы игрока №2: 0.3333")
        else:
        ...
        last_door = (door[1])
        if last_door == 'пусто':
            print('За дверью 1 или 3 находится приз')
            print("Игрок №2 изменил свой выбор")
            print("Шанс победы игрока №1: 0.6667")
            print("Шанс победы игрока №2: 0.3333")
        else:
            print("Игрок 1 изменил свой выбор и победил")
            print("Шанс победы 1 игрока: 0.6667")
            print("шанс победы 2 игрока: 0.3333")
